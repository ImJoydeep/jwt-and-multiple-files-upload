    ...
    <div class="flex justify-center items-center py-10">
      ...
      >
        ...
        <div class="mb-2">
          <label
            for="captcha"
            class="mt-2.5 text-gray-700 text-sm font-bold mb-2 w-1/2"
            >Captcha:-</label
          >
          <p
            class="my-2 bg-amber-200 p-2 text-lg rounded line-through font-bold w-1/2"
          >
            {{ captchaForm }}
          </p>
          <input
        ...
        <div>
          <p class="text-red-600 text-md text-center" v-if="errors">
            {{ errors }}
            ! Try Again
          </p>
        </div>
        <p class="my-2">
          <RouterLink to="/forgetpassword" class="text-blue-700"
